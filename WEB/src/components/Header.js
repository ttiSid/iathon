      ...
      <div className="header__container">
        <div className="header__discription">
          ...
          <p className="header__paragraph">
            ...
            do gasto global em saúde), dados de bases populacionais, prontuários
            eletrônicos ou dispositivos vestíveis ou de monitorização contínua
            da glicemia podem fornecer substrato para algoritmos que executem
            diagnósticos mais precoces e acurados
          </p>
